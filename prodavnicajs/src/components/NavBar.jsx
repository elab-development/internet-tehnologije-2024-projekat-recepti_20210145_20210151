            ...
            <ul className={`navbar-menu ${isMenuOpen ? 'active' : ''}`}>
                ...
                <ul className="dropdown-menu">
                    <li className="dropdown-item">
                        <Link to="/recepti/pretraga?tip_jela=predjelo">Predjelo</Link>
                    </li>
                    <li className="dropdown-item">
                        <Link to="/recepti/pretraga?tip_jela=glavno jelo">Glavno jelo</Link>
                    </li>
                    <li className="dropdown-item">
                        <Link to="/recepti/pretraga?tip_jela=desert">Desert</Link>
                    </li>
                    <li className="dropdown-item">
                        <Link to="/recepti/pretraga?tip_jela=salata">Salata</Link>
                    </li>
                </ul>
                </li>
